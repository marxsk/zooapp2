...
var AnimalDetail = React.createClass({
  render() {
    ...
    } else if (this.props.type === 'scrollHeader') {
      return this.render_scroll_header();
    } else if (this.props.type === 'scrollFlow') {
      return this.render_scroll_flow();
    } else {
      return (<View />);
    }
  },
